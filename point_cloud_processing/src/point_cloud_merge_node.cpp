...
void pointCloudCallback(const sensor_msgs::PointCloud2ConstPtr& msg1, const sensor_msgs::PointCloud2ConstPtr& msg2)
{
  ...
  {
    ROS_WARN("Cannot merge point clouds. One or both point clouds are empty.");
    return;
  }
...
int main(int argc, char** argv)
{
  ...
  nh.param<std::string>("/point_cloud_merge_node/point_cloud_merge/topic1", topic1, "/point_cloud1");
  nh.param<std::string>("/point_cloud_merge_node/point_cloud_merge/topic2", topic2, "/point_cloud2");
  ...
  merged_pub = nh.advertise<sensor_msgs::PointCloud2>("/merged_point_cloud", 1);
